...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="md:hidden absolute inset-x-0 pointer-events-none"
        style={{
          top: "calc(100vw - 120px)", height: "180px",
          background: "linear-gradient(180deg, rgba(14,14,14,0) 0%, rgba(14,14,14,0.75) 60%, #0e0e0e 100%)",
        }} />
      <div aria-hidden className="md:hidden absolute inset-x-0 top-0 h-20 pointer-events-none"
        style={{ background: "linear-gradient(180deg, rgba(14,14,14,0.75) 0%, rgba(14,14,14,0) 100%)" }} />
      ...
      <div aria-hidden className="hidden md:block absolute inset-x-0 top-0 h-40 pointer-events-none"
        style={{ background: "linear-gradient(180deg, rgba(10,10,10,0.75) 0%, rgba(10,10,10,0) 100%)" }} />
      <div aria-hidden className="hidden md:block absolute inset-x-0 bottom-0 h-56 pointer-events-none"
        style={{ background: "linear-gradient(180deg, rgba(10,10,10,0) 0%, rgba(10,10,10,0.85) 100%)" }} />

      <div aria-hidden className="hidden md:block absolute inset-0 pointer-events-none">
        <span className="absolute fi-float3d-c"
          style={{ top: "18%", left: "12%", width: "6px", height: "6px", borderRadius: "50%",
            background: "#E9C57A",
            boxShadow: "0 0 24px rgba(233,197,122,0.9), 0 0 60px rgba(203,161,83,0.55)",
            opacity: 0.8 }} />
        <span className="absolute fi-float3d-d"
          style={{ top: "32%", right: "16%", width: "4px", height: "4px", borderRadius: "50%",
            background: "#F5E0A8",
            boxShadow: "0 0 18px rgba(245,224,168,0.85), 0 0 50px rgba(203,161,83,0.5)",
            opacity: 0.75 }} />
        <span className="absolute fi-float3d-b"
          style={{ bottom: "24%", left: "40%", width: "5px", height: "5px", borderRadius: "50%",
            background: "#CBA153",
            boxShadow: "0 0 20px rgba(203,161,83,0.85), 0 0 50px rgba(203,161,83,0.5)",
            opacity: 0.7 }} />
      </div>

      <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 pb-20 md:pb-32 lg:pb-40 fi-3d-stage"
        style={{ paddingTop: isMobile ? "calc(100vw + 32px)" : undefined }}
      >
        <div className="mb-6 md:mb-8 fi-3d-layer fi-float3d-d">
          <SpreadOverline text="About the Studio"
        ...
        <div className="mt-6 md:mt-8 fi-gold-sweep"
          style={{
            height: "2px", width: "clamp(100px, 18vw, 220px)",
            background: "linear-gradient(90deg, rgba(203,161,83,0) 0%, #CBA153 20%, #E9C57A 60%, #CBA153 100%)",
        ...
        <div ref={bodyRef}
          ...
          <div className="lg:col-span-7 fi-3d-layer fi-float3d-b">
            ...
            <p className="mt-5 md:mt-6 fi-glow-text"
              style={{
          ...
          <div className="lg:col-span-5 relative">
            <div
              ...
              style={{
                ...
                boxShadow: "0 30px 80px -30px rgba(0,0,0,0.7), 0 0 0 1px rgba(203,161,83,0.12)",
                maxWidth: "420px",
                marginLeft: "auto",
            ...
            >
              <div className="overline" style={{ color: "#E9C57A", letterSpacing: "0.34em", fontSize: "0.68rem" }}>
                Studio Note
              </div>
              <p className="font-serif-display mt-4"
                style={{ color: "#F5EFE2", fontSize: "1rem", lineHeight: 1.6, fontStyle: "italic", fontWeight: 300 }}>
                "Unparalleled craftsmanship and artistry — turning houses into dream homes."
              </p>
              <div className="overline mt-5"
                style={{ color: "rgba(249,248,246,0.55)", letterSpacing: "0.32em", fontSize: "0.66rem" }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderLeft: "2px solid #CBA153",
                  boxShadow: "0 24px 60px -30px rgba(0,0,0,0.6), 0 0 0 1px rgba(203,161,83,0.1)",
              ...
              >
                ...
                <div className="font-serif-display mt-3 md:mt-4"
                  style={{ fontSize: "0.98rem", color: "#F9F8F6", lineHeight: 1.2, textShadow: "0 1px 8px rgba(0,0,0,0.5)" }}>
                  {p.label}
                </div>
                <div className="text-[11px] md:text-xs mt-1.5"
                  style={{ color: "rgba(249,248,246,0.65)", lineHeight: 1.55 }}>
                  {p.desc}
                </div>
              </div>
            );
